...
int main() {
	...
	int total, x, y, count;
	srand((unsigned int)time(NULL)); //để mỗi lần chạy random đều khác nhau
...
void countQuadraticEqu(double a, double b, double c)
{
    double d;
    d = (b * b) - 4 * (a * c);
...
void countBankDep(double d, double r, int y)
{	
    double money;
